window.MakeupGenerator = class MakeupGenerator {
     ...
     */
    displayElement(container, object, array, slide = false) {
     ...
     */
    removeArrayOfElements(stop, array) {
     ...
     */
    onSelection(question, updatedPastChoice) {
